...
/** @defgroup RCCEx_OSPI_Clock_Source OctoSPI Clock Source
  * @{
  */
#define RCC_OSPICLKSOURCE_HCLK       0x00000000U
#define RCC_OSPICLKSOURCE_SYSCLK     0x01000000U
#define RCC_OSPICLKSOURCE_MSIK       0x02000000U
#define RCC_OSPICLKSOURCE_PLL1       RCC_CCIPR2_OCTOSPISEL_0
#define RCC_OSPICLKSOURCE_PLL2       RCC_CCIPR2_OCTOSPISEL_1
#define RCC_OSPICLKSOURCE_PLL3       RCC_CCIPR2_OCTOSPISEL
/**
  * @}
  */

/** @defgroup RCCEx_HSPI_Clock_Source HSPI Clock Source
  * @{
  */
#define RCC_HSPICLKSOURCE_HCLK       0x00000000U
