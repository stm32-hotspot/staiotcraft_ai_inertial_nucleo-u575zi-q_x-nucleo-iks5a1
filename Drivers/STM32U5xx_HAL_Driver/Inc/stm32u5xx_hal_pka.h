...
typedef struct
{
  ...
  const uint8_t *integerK;             /*!< pointer to CIPHERIPtographically secure random integer k */
  const uint8_t *integerM;             /*!< pointer to CIPHERIPtographically secure random integer m */
