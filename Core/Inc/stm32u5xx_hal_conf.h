...
/**
  * @brief Internal High Speed oscillator (HSI48) value for USB FS and SDMMC.
...
#define HSI48_VALUE             48000000UL /*!< Value of the Internal High Speed oscillator for USB FS/SDMMC in Hz.
