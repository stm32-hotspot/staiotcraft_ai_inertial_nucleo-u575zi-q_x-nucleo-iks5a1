...
<label for="collapse-section10" aria-hidden="true">__v2.2.3 / 7-May-25__</label>
<div>			
...
- Added missing nullity check for PNPL_CMD_SET and PNPL_CMD_COMMAND
- Use ANSI standard data types: float_t, double_t and int32_t instead of float, double or int
...
<label for="collapse-section2" aria-hidden="true">__v1.2.0 / 24-Mar-23__</label>
<div>			
